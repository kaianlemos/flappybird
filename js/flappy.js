...
function ParDeBarreiras(altura, abertura, x) {
    ...
    this.getX = () => { return parseInt(this.elemento.style.left.split('px')[0]) }
    this.setX = (x) => { return this.elemento.style.left = `${x}px` }
    this.getLargura = () => { return this.elemento.clientWidth }
...
// const passaro = new Passaro(1000)
